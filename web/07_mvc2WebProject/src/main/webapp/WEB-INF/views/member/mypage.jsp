		...
		<form action="/updateMember" method="post">
			...
			<div class = "form-group">
				<fieldset>
					...
					<input type="text" id="memberName" name="memberName" class="form-control" value="<%=m.getMemberName() %>">
				</fieldset>
			</div>
			<div class = "form-group">
				<fieldset>
			...
			<div class = "form-group">
				<fieldset style="text-align:center;">
					...
					<%} else { %>
						<a href="/deleteMember?memberNo=<%=m.getMemberNo() %>" class="btn btn-outline-danger">회원탈퇴</a>
					<%} %>
				</fieldset>
			</div>
		</form>

            ...
            <div class="m_loginBox" id="m_loginContent">
                ...
                <div class="subBox">
                    ...
                    <div class="form-group">
                        <fieldset>
                            <input class="form-control" id="readOnlyInput" type="password"  placeholder="현재 비밀번호를 반드시 입력하세요" style="width:800px;">
                        </fieldset>
                    </div>
                </div>
                <form action="/updatePw" method="post" name="updatePw" onsubmit="return checkValue();">
                    ...
                    <div class="line"></div>
                    <div id="btnArea">  
                        <button type="submit" class="btn btn-secondary" id="mbtn" onclick="return checkValue();">확인</button>
                    </div>
                </form>
            </div>

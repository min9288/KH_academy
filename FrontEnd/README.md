...
- 49일차(2021-09-17)
 ...
 - 52일차(2021-09-27-8)
   - 14_반응형웹페이지.html : jQuery 반응형웹 테스트 프로그램
   - 15_footer위치잡기.html : jQuery footer 위치 잡기 테스트 프로그램
   - createWebExam 폴더 : 웹페이지 만들기 팀프로젝트 프로그램 폴더
      1. IT자격증 온라인 학원 웹페이지
      2. 총 5명이 수강신청, 교재구매, 장바구니 등등 여러기능을 맡아 제작
      3. 그 기능 중 수강신청, 교재구매, 장바구니 기능 구현
